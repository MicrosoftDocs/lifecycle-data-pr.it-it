...
ms.locfileid: "940876"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="71621-103">Esportazione dei dati del ciclo di vita</span><span class="sxs-lookup"><span data-stu-id="71621-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="71621-104">Questa pagina è in fase di sviluppo.</span><span class="sxs-lookup"><span data-stu-id="71621-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="71621-105">Esportare tutti i prodotti</span><span class="sxs-lookup"><span data-stu-id="71621-105">Export all products</span></span>
<span data-ttu-id="71621-106">Esportare i dati del ciclo di vita per tutti i prodotti facendo clic qui sotto:</span><span class="sxs-lookup"><span data-stu-id="71621-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="71621-107">Esportare tutti i prodotti</span><span class="sxs-lookup"><span data-stu-id="71621-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="71621-108">Esportare i prodotti per famiglia e gruppo</span><span class="sxs-lookup"><span data-stu-id="71621-108">Export products by Family and Group</span></span>
<span data-ttu-id="71621-109">Selezionare una famiglia e quindi un gruppo da esportare.</span><span class="sxs-lookup"><span data-stu-id="71621-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="71621-110">Nota: l'esportazione inizierà quando viene selezionato il valore del gruppo.</span><span class="sxs-lookup"><span data-stu-id="71621-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="71621-171">Esportare i prodotti entro la data di fine del supporto</span><span class="sxs-lookup"><span data-stu-id="71621-171">Export products by end of support date</span></span>
<span data-ttu-id="71621-172">Selezionare un anno per visualizzare i prodotti che raggiungono la fine del supporto.</span><span class="sxs-lookup"><span data-stu-id="71621-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="71621-173">Nota: l'esportazione inizierà quando viene selezionato il valore year.</span><span class="sxs-lookup"><span data-stu-id="71621-173">Note: Export will begin when Year value is selected.</span></span>
