...
ms.locfileid: "885015"
---
# <a name="export"></a><span data-ttu-id="7f443-103">Esporta</span><span class="sxs-lookup"><span data-stu-id="7f443-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="7f443-104">Questa pagina è in fase di sviluppo.</span><span class="sxs-lookup"><span data-stu-id="7f443-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="7f443-105">Esportare tutti i prodotti</span><span class="sxs-lookup"><span data-stu-id="7f443-105">Export All Products</span></span>
<span data-ttu-id="7f443-106">Esporta tutti i prodotti senza filtri.</span><span class="sxs-lookup"><span data-stu-id="7f443-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="7f443-107">Esportare tutti i prodotti</span><span class="sxs-lookup"><span data-stu-id="7f443-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="7f443-108">Esportare i prodotti per categoria</span><span class="sxs-lookup"><span data-stu-id="7f443-108">Export Products by Category</span></span>
<span data-ttu-id="7f443-109">Selezionare un raggruppamento da esportare:</span><span class="sxs-lookup"><span data-stu-id="7f443-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="7f443-167">Esportare i prodotti entro la fine dell'anno di supporto</span><span class="sxs-lookup"><span data-stu-id="7f443-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="7f443-168">Selezionare un anno per esportare i prodotti che terminano il servizio nello stesso anno:</span><span class="sxs-lookup"><span data-stu-id="7f443-168">Select a year to export products ending service in that year:</span></span>
